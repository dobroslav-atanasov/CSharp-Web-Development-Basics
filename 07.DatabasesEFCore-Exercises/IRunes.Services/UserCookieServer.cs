namespace IRunes.Services
{
    ...
    public class UserCookieServer : IUserCookieService
    {
        private const string EncryptKey = "E646C8DF278CD5931069B522E695D4F2";

        public string GetUserCookie(string username)
        {
            var cookieContent = this.EncryptString(username, EncryptKey);
